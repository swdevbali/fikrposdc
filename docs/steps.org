...
**** Fetch DataSet:monthlySalesReport from views.py. What branches sent is its dailyReport, later python able to create its weekly, monthly or of course, yearly report
